...
abstract class BasePersonProducer extends FairyProducer {

  private Person person;

  private String telephoneNumberFormat = generator.getValues(TELEPHONE_NUMBER_FORMATS);

  public BasePersonProducer(RandomDataGenerator generator, RandomGenerator random, StringifyUtil stringifyUtil1) {
    super(generator, random, stringifyUtil1);
  }

  public BasePersonProducer telephoneNumberFormat(String telephoneNumberFormat) {
